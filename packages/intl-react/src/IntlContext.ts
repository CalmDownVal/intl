import { ComponentClass, ComponentType, createContext, createElement, FunctionComponent, useContext } from 'react';
...
export function withIntl<TProps extends WithIntlProps>(component: ComponentClass<TProps>): FunctionComponent<Omit<TProps, 'intl'>>;
